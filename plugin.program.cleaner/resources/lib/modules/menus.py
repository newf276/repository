...
def submenu_maintenance():
    ...
    add_dir(COLOR4('Force Close'),'', 18, addon_icon,addon_fanart,COLOR2('Force Close Kodi'), isFolder=False)
    add_dir(COLOR3(local_string(30012)), '', 4, addon_icon, addon_fanart, COLOR2(local_string(30003)), isFolder=False)  # Fresh Start
def backup_restore():
