...
class MaintenanceMenu:
    ...
    def get_listing(self):
        directory.add_dir('[B][COLOR dodgerblue]Cleaning Tools[/B][/COLOR]', {'mode': 'maint', 'name': 'clean'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME1)
    ...
    def clean_menu(self):
        ...
        directory.add_file(
            '[COLOR dodgerblue]Total Clean Up:[/COLOR] [B]{0}[/B]'.format(tools.convert_size(totalsize)), {'mode': 'fullclean'},
