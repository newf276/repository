...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR dodgerblue][B]Newfs[/B][/COLOR] Wizard'
BUILDERNAME = 'Newf276'
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'https://www.dropbox.com/scl/fi/y3gyz9co212arqkwhgo1x/builds.txt?rlkey=ug0uqsu8umtn0sh6mqim35h6s&dl=1'  
...
THEME4 = u'[COLOR dodgerblue]Current Build:[/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing [COLOR dodgerblue][B]Newf276s[/B][/COLOR] Wizard and personal builds.'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR dodgerblue][B]Newfs[/B][/COLOR] Wizard'
# url to image if using Image 424x180
HEADERIMAGE = 'https://github.com/newf276/repository/raw/master/icon.png'
# Font for Notification Window
FONTSETTINGS = 'Font13'
# Background for Notification Window
BACKGROUND = 'https://github.com/newf276/repository/raw/master/fanart.jpg'
#########################################################
