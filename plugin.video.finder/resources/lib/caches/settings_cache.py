...
_SETTINGS_PROPERTIES_LOADED = 'finder.settings_properties_loaded'
_DEFERRED_SETUP_DONE = 'finder.deferred_service_setup_done'
_SETTINGS_DB_MIGRATED = 'finder.settings_db_migrated'
_SETTINGS_DB_SYNCED = 'finder.settings_db_synced'
_WIDGET_REFRESH_SCHEDULED = 'finder.widgets_refresh_scheduled'
...
class SettingsCache:
	...
	def set_memory_cache(self, setting_id, setting_value):
		try:
			kodi_utils.set_property('finder.%s' % setting_id, property_safe_string(setting_value))
		except: pass

	def delete_memory_cache(self, setting_id):
		clear_property('finder.%s' % setting_id)
...
def sync_settings(params={}):
	...
	if currentsettings:
		if currentsettings.get('update.username', '').replace('-', '').lower() == 'newf276' \
				and currentsettings.get('update.username') != 'newf276':
			settings_cache.write_db('update.username', 'newf276', defaults_map.get('update.username'))
			currentsettings['update.username'] = 'newf276'
			migrated = True
			if load_properties: settings_cache.set_memory_cache('update.username', 'newf276')
...
def set_path(params):
	...
	current = get_setting('finder.%s' % setting_id)
	if browse_mode == 0:
...
def default_setting_values(setting_id):
	if 'finder.' in setting_id: setting_id = setting_id.replace('finder.', '')
...
#===============================================================================#
#==================== General
{'setting_id': 'auto_start_finder', 'setting_type': 'boolean', 'setting_default': 'false'},
...
#==================== Manage Updates
{'setting_id': 'update.action', 'setting_type': 'action', 'setting_default': '1', 'settings_options': {'0': 'Prompt', '1': 'Automatic', '2': 'Notification', '3': 'Off'}},
{'setting_id': 'update.delay', 'setting_type': 'action', 'setting_default': '10', 'min_value': '10', 'max_value': '300'},
{'setting_id': 'update.username', 'setting_type': 'string', 'setting_default': 'newf276'},
{'setting_id': 'update.location', 'setting_type': 'string', 'setting_default': 'newf276.github.io'},
#==================== Watched Indicators
{'setting_id': 'watched_indicators', 'setting_type': 'action', 'setting_default': '1', 'settings_options': {'0': 'Finder', '1': 'Trakt'}},
#======+============= Trakt Cache
{'setting_id': 'trakt.sync_interval', 'setting_type': 'action', 'setting_default': '20', 'min_value': '5', 'max_value': '600'},
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.finder/Movies Downloads/', 'browse_mode': '0'},
{'setting_id': 'tvshow_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.finder/TV Show Downloads/', 'browse_mode': '0'},
{'setting_id': 'premium_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.finder/Premium Downloads/', 'browse_mode': '0'},
{'setting_id': 'image_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.finder/Image Downloads/', 'browse_mode': '0'},
{'setting_id': 'import_export_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.finder/Import Export/', 'browse_mode': '0'},
...
{'setting_id': 'media_open_action_movie', 'setting_type': 'action', 'setting_default': '1', 'settings_options': {'0': 'None', '1': 'Open Extras', '2': 'Open Movie Set', '3': 'Both'}},
...
{'setting_id': 'paginate.limit_addon', 'setting_type': 'action', 'setting_default': '50'},
{'setting_id': 'paginate.limit_widgets', 'setting_type': 'action', 'setting_default': '50'},
...
{'setting_id': 'use_season_name', 'setting_type': 'boolean', 'setting_default': 'true'},
...
{'setting_id': 'view.movies', 'setting_type': 'string', 'setting_default': '50'},
{'setting_id': 'view.tvshows', 'setting_type': 'string', 'setting_default': '50'},
...
#==================================================================================#
#==================== General
{'setting_id': 'single_ep_display', 'setting_type': 'action', 'setting_default': '2', 'settings_options': {'0': 'TITLE: SxE - EPISODE', '1': 'SxE - EPISODE', '2': 'EPISODE'}},
{'setting_id': 'single_ep_display_widget', 'setting_type': 'action', 'setting_default': '2', 'settings_options': {'0': 'TITLE: SxE - EPISODE', '1': 'SxE - EPISODE', '2': 'EPISODE'}},
{'setting_id': 'single_ep_unwatched_episodes', 'setting_type': 'boolean', 'setting_default': 'true'},
#==================== Next Episodes
...
{'setting_id': 'nextep.limit_history', 'setting_type': 'boolean', 'setting_default': 'true'},
{'setting_id': 'nextep.limit', 'setting_type': 'action', 'setting_default': '30', 'min_value': '1', 'max_value': '200'},
...
{'setting_id': 'trakt.calendar_previous_days', 'setting_type': 'action', 'setting_default': '1', 'min_value': '0', 'max_value': '14'},
...
{'setting_id': 'trakt.client', 'setting_type': 'string', 'setting_default': 'd37e53be8a9ad6a243d6e72e6271de71bac2f718c8c512b93198bf3fd747ec37'},
{'setting_id': 'trakt.secret', 'setting_type': 'string', 'setting_default': 'f1006109f91fb48f1fa97abb9fe35506e72af8843972efedfd0c7c544bfa63dd'},
#==================== TMDb API
{'setting_id': 'tmdb_api', 'setting_type': 'string', 'setting_default': '772defd0fb9daa76166a0163c458ad7e'},
#==================== TMDb Lists
...
{'setting_id': 'external_scraper.name', 'setting_type': 'string', 'setting_default': 'script.module.newfsscrapers'},
...
{'setting_id': 'pm.priority', 'setting_type': 'action', 'setting_default': '2', 'min_value': '1', 'max_value': '10'},
#==================== All Debrid
...
{'setting_id': 'oc.priority', 'setting_type': 'action', 'setting_default': '8', 'min_value': '1', 'max_value': '10'},
#==================== TorBox
...
{'setting_id': 'tb.priority', 'setting_type': 'action', 'setting_default': '1', 'min_value': '1', 'max_value': '10'},
#==================== EasyNews
...
{'setting_id': 'aio.priority', 'setting_type': 'action', 'setting_default': '6', 'min_value': '1', 'max_value': '10'},
...
{'setting_id': 'results.episode_size_max', 'setting_type': 'action', 'setting_default': '20000', 'min_value': '1'},
...
{'setting_id': 'provider.rd_highlight', 'setting_type': 'string', 'setting_default': 'FFFE9900'},
{'setting_id': 'provider.pm_highlight', 'setting_type': 'string', 'setting_default': 'FFFF335C'},
...
{'setting_id': 'provider.tb_highlight', 'setting_type': 'string', 'setting_default': 'FF33ADFF'},
