...
class Downloader:
	...
	def remove_active_download(self):
		...
		if active_downloads: kodi_utils.set_property('finder.active_downloads', json.dumps(active_downloads))
	...
	def check_status(self):
		...
		if status in ('unpaused', 'cancelled'): kodi_utils.clear_property('finder.download_status.%s' % self.final_name)
		return status
