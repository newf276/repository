...
RATINGS_DATABASE_PATH = xbmcvfs.translatePath(
    "special://profile/addon_data/script.flix.helper/ratings_cache.db"
)
RATINGS_IMAGE_PATH = "special://home/addons/skin.flix/resources/rating_images/"
PROFILE_PATH = xbmcvfs.translatePath(
    "special://userdata/addon_data/script.flix.helper/current_profile.json"
)
