...
def clear_color_cache(delete=False):
    ...
    if not delete:
        ...
        if dialog.yesno("Flix", "Are you sure you want to clear the color cache?"):
            delete = True
    ...
    if delete:
        try:
            ...
            dialog = xbmcgui.Dialog()
            dialog.notification(
                "Flix", "Error clearing color cache", xbmcgui.NOTIFICATION_ERROR
            )
            return False
...
def clear_logo_cache(delete=False):
    ...
    if not delete:
        dialog = xbmcgui.Dialog()
        if dialog.yesno("Flix", "Are you sure you want to clear the logo cache?"):
            delete = True
    ...
    if delete:
        try:
            ...
            dialog = xbmcgui.Dialog()
            dialog.notification(
                "Flix", "Error clearing logo cache", xbmcgui.NOTIFICATION_ERROR
            )
            return False
...
def clear_blur_cache(delete=False):
    ...
    if not delete:
        dialog = xbmcgui.Dialog()
        if dialog.yesno("Flix", "Are you sure you want to clear the blur cache?"):
            delete = True
    ...
    if delete:
        try:
            ...
            dialog = xbmcgui.Dialog()
            dialog.notification(
                "Flix", "Error clearing blur cache", xbmcgui.NOTIFICATION_ERROR
            )
            return False
...
def clear_all_image_caches(clear=False):
    ...
    if not clear:
        dialog = xbmcgui.Dialog()
        if dialog.yesno("Flix", "Are you sure you want to clear all caches?"):
            clear = True
