...
stacked_media_xml_body = """ 
    ...
    <include content="{cpath_type}">
      <param name="content_path" value="$INFO[Window(Home).Property(flix.{cpath_list_id}.path)]"/>
      <param name="widget_header" value="$INFO[Window(Home).Property(flix.{cpath_list_id}.label)]"/>
      <param name="widget_target" value="videos"/>
...
history_xml_body = """
    <item>
      ...
      <onclick>RunScript(script.flix.helper,mode=re_search)</onclick>
    </item>"""
