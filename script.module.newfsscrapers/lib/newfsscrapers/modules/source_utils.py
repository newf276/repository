...
from newfsscrapers.modules import cleantitle
from newfsscrapers.modules.undesirables import Undesirables
from newfsscrapers.modules.control import homeWindow, setting as getSetting, setSetting
...
UNDESIRABLES = ['400p.octopus', '720p.octopus', '1080p.octopus', 'alexfilm', 'amedia', 'audiobook', 'baibako', 'bigsinema', 'bonus.disc', 'casstudio.tv', 'courage.bambey',
				...
				'Newf Sscrapers.media', 'Newf Sscrapersmedia', 'good.people', 'gostfilm', 'hamsterstudio', 'hdrezka', 'hdtvrip', 'hurtom', 'idea.film', 'ideafilm', 'jaskier', 'kapatejl6', 'kb.1080p',
