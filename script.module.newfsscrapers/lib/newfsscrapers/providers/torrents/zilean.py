...
import queue
from newfsscrapers.modules import client
from newfsscrapers.modules import source_utils
from newfsscrapers.modules.control import setting as getSetting
...
class source:
	...
	def __init__(self):
		self.language = ['en']
		self.base_link = "https://zileanfortheweebs.midnightignite.me"
