...
import urllib.error
import urllib.parse
from viperscrapers.modules.control import setting as getSetting, notification
from viperscrapers.modules.log_utils import LOGINFO
...
class Prowlarr:
    ...
    def pretty_print(self, value: any):
        xbmc.log('script.module.viperscrapers' + str(value), LOGINFO)
